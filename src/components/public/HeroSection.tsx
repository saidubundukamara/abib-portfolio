  ...
  return (
    <section className="pt-6 pb-12 lg:pb-0">
      ...
      <div className="grid grid-cols-2 gap-4 mt-8">
        {/* Orange card */}
        <div
          className="relative overflow-hidden rounded-[16px] p-6 flex flex-col justify-between"
          style={{ backgroundColor: 'rgb(244,108,56)', minHeight: '220px' }}
        >
          {/* Decorative wave */}
          <svg
          ...
          <Layers size={30} color="white" className="relative z-10" />
          <div className="relative z-10 flex items-end justify-between gap-2">
            <p className="font-bold text-white text-[13px] uppercase leading-snug tracking-wide">
        ...
        <div
          className="relative overflow-hidden rounded-[16px] p-6 flex flex-col justify-between"
          style={{ backgroundColor: 'rgb(197,255,65)', minHeight: '220px' }}
        >
          <svg
            className="absolute inset-0 w-full h-full"
            viewBox="0 0 300 220"
          ...
          <LayoutDashboard size={30} color="rgb(21,19,18)" className="relative z-10" />
          <div className="relative z-10 flex items-end justify-between gap-2">
            <p
              className="font-bold text-[13px] uppercase leading-snug tracking-wide"
            ...
            >
              <ArrowRight size={16} color="rgb(21,19,18)" />
            </div>
          </div>
        </div>
      </div>
